...
try {
  ...
  console.log("Packaged desktop acceptance passed: fresh startup, historical upgrade, financial, communication, library, forms, and events schemas, recovery snapshot, SQLite integrity, and privacy metadata.");
} finally {
