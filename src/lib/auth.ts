...
export type Permission = "VIEW_PEOPLE" | "VIEW_CONTACT_DETAILS" | "VIEW_FAMILY_LINKS" | "MANAGE_PEOPLE" | "VIEW_GROUPS" | "MANAGE_GROUPS" | "VIEW_INVENTORY" | "MANAGE_INVENTORY" | "MANAGE_ASSIGNMENTS" | "VIEW_REPAIRS" | "MANAGE_REPAIRS" | "VIEW_REPORTS" | "VIEW_FINANCIALS" | "MANAGE_FINANCIALS" | "VIEW_COMMUNICATIONS" | "MANAGE_COMMUNICATIONS" | "VIEW_LIBRARY" | "MANAGE_LIBRARY" | "VIEW_FORMS" | "MANAGE_FORMS" | "RECORD_FORM_RESPONSES" | "VIEW_EVENTS" | "MANAGE_EVENTS" | "RECORD_ATTENDANCE" | "EXPORT_DATA" | "ROLLOVER" | "MANAGE_SETTINGS" | "MANAGE_USERS" | "VIEW_NOTES" | "RUN_MIGRATION";
...
const ROLE_PERMISSIONS: Record<StaffRole, ReadonlySet<Permission>> = {
  ...
  [StaffRole.ASSISTANT_DIRECTOR]: new Set(ALL_PERMISSIONS.filter((permission) => !["ROLLOVER", "MANAGE_SETTINGS", "MANAGE_USERS", "RUN_MIGRATION"].includes(permission))),
