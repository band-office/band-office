...
export const formQuestions = [
  ...
  { id: "form-question-trip-6", versionId: formTemplateVersions[0].id, position: 6, prompt: "Optional approved district document", helpText: "Upload only files your school permits BandOS to retain.", type: FormQuestionType.FILE_UPLOAD, required: false, optionsJson: null },
