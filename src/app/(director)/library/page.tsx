...
import { BookCopy, Clock3, Music2, Plus, Search } from "lucide-react";
...
export default async function LibraryPage({ searchParams }: { searchParams: Promise<{ q?: string; status?: string; category?: string; success?: string; error?: string }> }) {
  ...
  return <main className="content">
    <PageHeader eyebrow="Whole score-and-parts sets" title="Music library" description="Catalog, loans, missing parts, resources, and performance history." icon={BookCopy} actions={canManage ? <details className="popover wide"><summary className="button primary"><Plus size={17} />Add music</summary><form action={createLibraryItemAction} className="popover-panel form-grid library-item-form"><h3>New whole-set record</h3><Field label="Title" wide><input name="title" required autoFocus /></Field><Field label="Composer"><input name="composer" /></Field><Field label="Arranger"><input name="arranger" /></Field><Field label="Publisher"><input name="publisher" /></Field><Field label="Grade"><input name="grade" placeholder="2.5" /></Field><Field label="Category"><input name="category" placeholder="Concert band" /></Field><Field label="Catalog number"><input name="catalogNumber" /></Field><Field label="Storage location"><input name="storageLocation" placeholder="Shelf B-4" /></Field><Field label="Acquired"><input name="acquisitionDate" type="date" /></Field><Field label="Acquisition source"><input name="acquisitionSource" /></Field><Field label="Acquisition cost"><input name="acquisitionCost" type="number" min="0" step="0.01" /></Field><Field label="Comments" wide hint="Do not enter student information in library comments."><textarea name="comments" rows={3} /></Field><div className="form-actions field-wide"><SubmitButton>Add to library</SubmitButton></div></form></details> : undefined} />
    <FlashMessage {...params} />
