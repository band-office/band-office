...
The public-release cleanup, protected `desktop-alpha-release` environment, required reviewer, native package acceptance, and [`v0.1.0-alpha.13`](https://github.com/band-office/band-office/releases/tag/v0.1.0-alpha.13) publication are complete. Apple Silicon and Intel macOS packages are Developer ID-signed, Apple-notarized, stapled, and Gatekeeper-validated. Windows x64 remains unsigned with checksums and SmartScreen guidance.
