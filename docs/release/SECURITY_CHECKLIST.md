...
**Release state:** public source; Developer ID-signed and Apple-notarized Desktop `v0.1.0-alpha.17` prerelease; district-operated Server `v0.1.0-server-alpha.5` prerelease
