...
> **Current release:** Desktop `v0.1.0-alpha.14` uses this path for both Apple Silicon and Intel downloads. Each published application is Developer ID-signed, Apple-notarized, stapled, and Gatekeeper-validated. This guide remains the maintainer setup and credential-rotation reference.
