...
- [x] A pinned CodeQL `security-extended` workflow analyzes JavaScript and TypeScript on pull requests, `main`, and a weekly schedule. Its first pull-request analysis evaluated 103 rules with zero results, and the protected-`main` ruleset blocks CodeQL analysis errors or high-and-higher security alerts (`.github/workflows/codeql.yml`, [run `30297211320`](https://github.com/band-office/band-office/actions/runs/30297211320), [ruleset `19774425`](https://github.com/band-office/band-office/rules/19774425)).
